    ...
    <div className="min-h-screen w-full bg-background">
      ...
      <main className="container relative mx-auto -mt-[490px] px-4 sm:px-6 md:px-12 pb-8">
        <div aria-hidden="true" className="absolute inset-0 -top-96 -z-10 overflow-hidden transform-gpu blur-3xl">
            <div
              className="relative left-[calc(50%-15rem)] aspect-[1155/678] w-[72.125rem] -translate-x-1/4 rotate-[30deg] bg-gradient-to-tr from-primary/70 to-accent/90 opacity-50 sm:left-[calc(50%-40rem)] sm:w-[90.1875rem]"
              style={{
                clipPath:
