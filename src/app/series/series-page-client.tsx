...
export default function SeriesPageClient({
    ...
    const buildUrl = useCallback((updates: Record<string, string | undefined>) => {
        ...
        return `/series${params.toString() ? `?${params.toString()}` : ''}`;
    }, [searchParams]);
    ...
    const handlePageChange = useCallback((page: number) => {
        ...
        navigateWithTransition(`/series?${params.toString()}`);
            ...
            <div className="max-w-7xl mx-auto px-4 pt-20 pb-8">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {(searchParams.genre || searchParams.year) && (
                            <Button
                                variant="ghost"
                                size="sm"
                                onClick={() => navigateWithTransition('/series')}
                            >
                                Clear
                            </Button>
                        )}
                        ...
                        {/* Create Button */}
                        <Button
                            className="rounded-md bg-white/5 hover:bg-white/10 border border-white/5 text-white/80 hover:text-white ml-2"
                ...
                {initialPosts.length === 0 ? (
                    <div className="text-center py-20">
                        ...
                        <Button onClick={() => navigateWithTransition('/series')}>
                            Clear Filters
                        </Button>
                    </div>
                ) : (
