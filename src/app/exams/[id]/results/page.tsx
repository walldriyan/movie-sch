...
import { AlertCircle, Check, X, Award, Percent, Target, FileQuestion, MessageSquare } from 'lucide-react';
import { Separator } from '@/components/ui/separator';
import { cn } from '@/lib/utils';
import Link from 'next/link';

export default async function ExamResultsPage({ params, searchParams }: { params: { id: string }, searchParams: { submissionId?: string } }) {
    ...
    const submissionId = searchParams.submissionId ? parseInt(searchParams.submissionId, 10) : undefined;
    ...
    try {
        const submission = await getExamResults(submissionId);
