...
import { Sparkles, AlertCircle, Loader2, Mail, Lock, ArrowRight, Eye, EyeOff, User, CheckCircle } from 'lucide-react';
import { doSignIn, registerUser, getSuperAdminEmailForDebug } from '@/lib/actions';
...
export default function AuthPage() {
    ...
    const [loginState, loginAction] = useActionState(doSignIn, { success: false, error: undefined });
    ...
    }, [loginState.success, searchParams]);
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        ...
                        <TabsContent value="register">
                            <form action={registerAction} className="space-y-5">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="register-name" className="text-white/70">Full Name</Label>
                                    <div className="relative">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="register-email" className="text-white/70">Email</Label>
                                    <div className="relative">
                                        <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-white/40" />
                                        <Input
                                            id="register-email"
