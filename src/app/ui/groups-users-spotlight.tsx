      ...
      return (
        ...
        >
           <div className="relative group">
              ...
              <div className="absolute bottom-1 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-black/20 backdrop-blur-sm text-white text-xs font-semibold max-w-[90%] truncate">
                {item.name}
              </div>
           </div>
        </div>
